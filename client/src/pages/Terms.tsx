          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                We may update these Terms from time to time. Your continued use of the Service after any changes constitutes 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                you are at least 18 years of age and have the legal capacity to enter into these Terms. If you are using the 
                Service on behalf of a business or organization, you represent that you have the authority to bind that entity 
                to these Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                AI-powered features (Sleeky AI), and integrations with third-party services including QuickBooks Online.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                The Service is provided on an "as is" and "as available" basis. We reserve the right to modify, suspend, or 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                are being used for fraudulent or illegal purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">5.1 Subscription Plans</h3>
              <p className="text-muted-foreground leading-relaxed">
                SleekInvoices offers both free and paid subscription plans. The features available to you depend on your 
                subscription level. Details of current plans and pricing are available on our website.
              </p>

              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">5.2 Billing</h3>
              <p className="text-muted-foreground leading-relaxed">
                Paid subscriptions are billed in advance on a monthly or annual basis, depending on the plan you select. 
                By subscribing to a paid plan, you authorize us to charge your payment method for the subscription fees. 
                All fees are quoted in US dollars unless otherwise specified.
              </p>

              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">5.3 Automatic Renewal</h3>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">5.4 Price Changes</h3>
              <p className="text-muted-foreground leading-relaxed">
                We reserve the right to change our pricing with at least 30 days' notice. Price changes will take effect at 
                the start of your next billing period after the notice period.
              </p>

              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">5.5 Refunds</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">6. AI Features (Sleeky AI)</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Service includes AI-powered features ("Sleeky AI") that use machine learning to assist with invoicing tasks. 
                By using these features, you agree to the following:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li><strong className="text-foreground">AI Credits:</strong> AI features consume credits based on your subscription plan. Free users receive limited credits; Pro users receive additional credits monthly.</li>
                <li><strong className="text-foreground">Content Responsibility:</strong> You are responsible for reviewing and approving all AI-generated content before use. AI outputs may contain errors or inaccuracies.</li>
                <li><strong className="text-foreground">No Guarantees:</strong> AI features are provided as-is without guarantees of accuracy, completeness, or fitness for any particular purpose.</li>
                <li><strong className="text-foreground">Prohibited Uses:</strong> You may not use AI features to generate illegal, harmful, fraudulent, or misleading content.</li>
                <li><strong className="text-foreground">Third-Party Providers:</strong> AI features are powered by third-party AI providers. Your use is subject to their terms and usage policies.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>Use the Service for fraudulent purposes or to create fraudulent invoices</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Service may integrate with third-party services, including but not limited to QuickBooks Online, Stripe, 
                and NOWPayments. When you connect your account to a third-party service:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">9.1 Our Intellectual Property</h3>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">9.2 Your Content</h3>
              <p className="text-muted-foreground leading-relaxed">
                You retain ownership of any content you create using the Service, including invoices, client data, and 
                business information. By using the Service, you grant us a limited license to use, store, and process your 
                content solely to provide the Service to you.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">10. Data and Privacy</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <div className="p-4 bg-muted/30 border border-border rounded-lg">
                <p className="text-muted-foreground leading-relaxed uppercase text-sm">
                  ...
                  NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE, OR THAT 
            ...
            <section>
              ...
              <div className="p-4 bg-muted/30 border border-border rounded-lg">
                <p className="text-muted-foreground leading-relaxed uppercase text-sm">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, SLEEKINVOICES AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS 
                  SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS 
                  OF PROFITS, REVENUES, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, 
                  ARISING FROM YOUR USE OF THE SERVICE. IN NO EVENT SHALL OUR TOTAL LIABILITY EXCEED THE AMOUNT YOU PAID US IN 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify, defend, and hold harmless SleekInvoices and its officers, directors, employees, 
                agents, and affiliates from and against any claims, damages, losses, liabilities, costs, and expenses 
                (including reasonable attorneys' fees) arising from or related to: (a) your use of the Service; (b) your 
                violation of these Terms; (c) your violation of any rights of another party; or (d) your content.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>We may delete your data after 90 days (see our Privacy Policy for details)</li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">15.1 Informal Resolution</h3>
              <p className="text-muted-foreground leading-relaxed">
                Before filing a formal dispute, you agree to contact us at{" "}
                <a href="mailto:legal@sleekinvoices.com" className="text-primary hover:underline">legal@sleekinvoices.com</a>{" "}
                to attempt to resolve the dispute informally. We will work in good faith to resolve any issues within 30 days.
              </p>

              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">15.2 Binding Arbitration</h3>
              <p className="text-muted-foreground leading-relaxed">
                If we cannot resolve a dispute informally, you agree that any dispute, claim, or controversy arising from or 
                relating to these Terms or the Service shall be resolved by binding arbitration, rather than in court. The 
                arbitration shall be conducted in accordance with the rules of the American Arbitration Association (AAA).
              </p>

              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">15.3 Class Action Waiver</h3>
              <p className="text-muted-foreground leading-relaxed">
                You agree that any arbitration or legal proceeding shall be conducted on an individual basis and not as a 
                class action, collective action, or representative action. You waive any right to participate in a class 
                action lawsuit or class-wide arbitration.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">16. Governing Law</h2>
              <p className="text-muted-foreground leading-relaxed">
                These Terms shall be governed by and construed in accordance with the laws of the State of Delaware, 
                United States, without regard to its conflict of law provisions. Any legal action or proceeding not subject 
                to arbitration shall be brought exclusively in the federal or state courts located in Delaware.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">17. Force Majeure</h2>
              <p className="text-muted-foreground leading-relaxed">
                We shall not be liable for any failure or delay in performing our obligations under these Terms due to 
                circumstances beyond our reasonable control, including but not limited to acts of God, natural disasters, 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                you and SleekInvoices regarding the Service and supersede all prior agreements, understandings, and 
