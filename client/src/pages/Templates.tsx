...
export default function InvoiceTemplates() {
  ...
  const sleekTemplate = templates?.find(t => t.name.toLowerCase().includes('sleek'));
  const customTemplates = templates?.filter(t => !t.name.toLowerCase().includes('sleek')) || [];
            ...
            <div className="w-full max-w-md text-center space-y-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  Create beautiful, professional invoices with our customizable Sleek template
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  <div className="grid md:grid-cols-5 gap-0">
                    ...
                    <div className="md:col-span-2 p-6 flex flex-col">
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold mb-2">{sleekTemplate.name}</h3>
                        <p className="text-sm text-muted-foreground mb-6">
                          Fully customizable with Google Fonts and brand colors
                        </p>
                        ...
                        <div className="space-y-3 mb-6">
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">{sleekTemplate.headingFont}</span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <div className="flex gap-1">
                              <div 
                                ...
                                style={{ backgroundColor: sleekTemplate.primaryColor }}
                              />
                              <div 
                                className="w-4 h-4 rounded-full ring-1 ring-black/10"
                                style={{ backgroundColor: sleekTemplate.secondaryColor }}
                              />
                              <div 
                                className="w-4 h-4 rounded-full ring-1 ring-black/10"
                                style={{ backgroundColor: sleekTemplate.accentColor }}
                              />
                            </div>
                          </div>
                        </div>
            ...
            {!sleekTemplate && (
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold mb-2">Get the Sleek Template</h3>
                ...
                <Button
                  ...
                  disabled={initializeMutation.isPending}
                >
                  {initializeMutation.isPending ? "Creating..." : "Create Sleek Template"}
                </Button>
              </div>
            )}
            ...
            {customTemplates.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold mb-4">Your Variations</h3>
