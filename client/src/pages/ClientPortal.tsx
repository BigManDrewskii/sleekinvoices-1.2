...
export default function ClientPortal() {
  ...
  const {
    ...
    error: clientError,
  } = trpc.clientPortal.getClientInfo.useQuery(
    { accessToken },
    {
      enabled: !!accessToken,
      retry: false,
  ...
  const { data: invoices, isLoading: invoicesLoading } =
    trpc.clientPortal.getInvoices.useQuery(
      { accessToken },
      {
  ...
  useEffect(() => {
    if (paymentStatus === "success") {
      toast.success(
        "Payment submitted! It may take a few minutes to confirm on the blockchain."
      );
        ...
        <Card className="max-w-md">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Invalid or expired access token. Please contact your service
              provider.
            </p>
          </CardContent>
        </Card>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        {remaining > 0 &&
                          remaining < parseFloat(invoice.total) && (
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div className="flex gap-2 mt-2 justify-end">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              window.open(
                                `/api/invoices/${invoice.id}/pdf?token=${accessToken}`,
                                "_blank"
                              )
                            }
                          >
            ...
            {!paymentUrl ? (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-sm text-amber-700 dark:text-amber-300">
                            For amounts under $10, we recommend using low-fee
                            cryptocurrencies:
                          </p>
                ...
                <div className="rounded-lg bg-[hsl(var(--color-bitcoin))]/5 border border-[hsl(var(--color-bitcoin))]/20 p-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-background text-xs font-medium">
                      <span className="text-[hsl(var(--color-bitcoin))]">
                        ₿
                      </span>{" "}
                      BTC
                    </span>
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-background text-xs font-medium">
                      <span className="text-[hsl(var(--color-ethereum))]">
                        Ξ
                      </span>{" "}
                      ETH
                    </span>
              ...
              <>
                ...
                <div className="rounded-lg bg-green-500/10 border border-green-500/20 p-4 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Click the button below to choose your preferred
                    cryptocurrency and complete your payment on the NOWPayments
