  ...
  return (
    ...
    >
      ...
      <div className="p-3 h-full flex flex-col">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="text-right">
            <div 
              ...
              style={{ color: template.primaryColor, fontFamily: template.headingFont }}
            >
              INVOICE
            </div>
            <div className="text-[3px] mt-0.5" style={{ color: template.secondaryColor }}>
              #INV-001
            </div>
          </div>
        </div>
        ...
        {/* Table Header */}
        <div 
          className="flex gap-1 py-0.5 border-b mb-1"
          style={{ borderColor: template.primaryColor }}
        >
          <div className="flex-1 text-[3px] font-semibold" style={{ color: template.primaryColor }}>
            Description
          </div>
          <div className="w-4 text-[3px] text-right font-semibold" style={{ color: template.primaryColor }}>
            Qty
          </div>
          <div className="w-6 text-[3px] text-right font-semibold" style={{ color: template.primaryColor }}>
            Rate
          </div>
          <div className="w-6 text-[3px] text-right font-semibold" style={{ color: template.primaryColor }}>
            Amt
        ...
        <div className="flex justify-end mt-auto pt-2">
          <div className="w-16 space-y-0.5">
            <div className="flex justify-between">
              <span className="text-[3px]" style={{ color: template.secondaryColor }}>Subtotal</span>
              <span className="text-[3px]" style={{ color: template.secondaryColor }}>$200</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[3px]" style={{ color: template.accentColor }}>Discount</span>
              <span className="text-[3px]" style={{ color: template.accentColor }}>-$20</span>
            </div>
            <div 
