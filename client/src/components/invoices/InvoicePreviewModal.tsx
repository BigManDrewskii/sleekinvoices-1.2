...
type InvoiceStyle = "classic" | "receipt" | "generated";
      ...
      <DialogContent className="max-w-5xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <DialogBody className="flex-1 overflow-hidden flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex bg-muted/50 p-0.5 rounded-lg">
                ...
                {pdfUrl && (
                  <button
                    onClick={() => {
                      setInvoiceStyle("generated");
                      setShowGeneratedPDF(true);
                    }}
                    className={cn(
                      "flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all",
                      invoiceStyle === "generated"
                        ? "bg-background text-foreground shadow-sm"
                        : "text-muted-foreground hover:text-foreground"
                    )}
                  >
          ...
          <div className="flex-1 overflow-hidden">
            {invoiceStyle === "generated" && pdfUrl ? (
              <div className="h-full flex flex-col">
                <PDFViewerModal
                  open={showGeneratedPDF}
                  onOpenChange={setShowGeneratedPDF}
                  pdfUrl={pdfUrl}
