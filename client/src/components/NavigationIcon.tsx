...
const iconMap: Record<string, React.ComponentType<{ weight?: IconWeight; className?: string }>> = {
 ...
 */
export function NavigationIcon({ icon, isActive = false, className = "" }: NavigationIconProps) {
