...
interface ResponsiveLogoEnhancedProps {
...
/**
 * Enhanced ResponsiveLogo component with support for:
 ...
 */
export function ResponsiveLogoEnhanced({
  variant = "wide",
  showBrand = false,
  className,
  responsive = true,
  alt = "SleekInvoices Logo",
}: ResponsiveLogoEnhancedProps) {
