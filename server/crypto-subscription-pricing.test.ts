...
describe('Crypto Subscription Pricing', () => {
  describe('CRYPTO_SUBSCRIPTION_TIERS', () => {
    ...
    it('should have correct monthly tier pricing', () => {
      ...
      expect(tier.pricePerMonth).toBe(10.00);
      expect(tier.totalPrice).toBe(10.00);
    ...
    it('should have correct quarterly tier pricing', () => {
      ...
      expect(tier.pricePerMonth).toBe(9.50);
      expect(tier.totalPrice).toBe(28.50);
    ...
    it('should have correct biannual tier pricing', () => {
      ...
      expect(tier.pricePerMonth).toBe(9.00);
      expect(tier.totalPrice).toBe(54.00);
    ...
    it('should have correct annual tier pricing', () => {
      ...
      expect(tier.pricePerMonth).toBe(8.50);
      expect(tier.totalPrice).toBe(102.00);
  ...
  describe('getCryptoPrice', () => {
    it('should return correct price for valid durations', () => {
      expect(getCryptoPrice(1)).toBe(10.00);
      expect(getCryptoPrice(3)).toBe(28.50);
      expect(getCryptoPrice(6)).toBe(54.00);
      expect(getCryptoPrice(12)).toBe(102.00);
    });
  ...
  describe('getCryptoSavings', () => {
    it('should calculate correct savings vs card price', () => {
      ...
      expect(getCryptoSavings(1)).toBe(2.00);   // $12 - $10 = $2
      expect(getCryptoSavings(3)).toBe(7.50);   // $36 - $28.50 = $7.50
      expect(getCryptoSavings(6)).toBe(18.00);  // $72 - $54 = $18
      expect(getCryptoSavings(12)).toBe(42.00); // $144 - $102 = $42
    });
  ...
  describe('Pricing consistency', () => {
    ...
    it('should have increasing savings as duration increases', () => {
      ...
      for (let i = 1; i < tiers.length; i++) {
        expect(tiers[i].savingsPercent).toBeGreaterThan(tiers[i - 1].savingsPercent);
      }
    });
