...
describe('Receipt Style Invoice - Line Item Calculations', () => {
  ...
  it('calculates line item amount correctly', () => {
    expect(calculateLineItemAmount({ description: 'Test', quantity: 2, rate: 100 })).toBe(200);
    expect(calculateLineItemAmount({ description: 'Test', quantity: 5, rate: 49.99 })).toBeCloseTo(249.95);
  });
