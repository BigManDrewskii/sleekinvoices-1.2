...
describe('Navigation - Responsive Logo Configuration', () => {
  ...
  it('should have responsive classes for wide logo', () => {
    const wideLogo = {
      classes: ['hidden', 'md:block', 'navbar-logo-wide', 'transition-all', 'duration-150', 'ease-out', 'group-hover:scale-[1.03]', 'group-hover:brightness-110', 'group-active:scale-[0.98]'],
    };
  ...
  it('should have responsive classes for monogram', () => {
    const monogram = {
      classes: ['md:hidden', 'navbar-logo-compact', 'transition-all', 'duration-150', 'ease-out', 'group-hover:scale-110', 'group-hover:brightness-110', 'group-hover:drop-shadow-[0_0_8px_rgba(99,102,241,0.3)]', 'group-active:scale-95'],
    };
